...
import 'package:bimta/screens/mahasiswa/bimbingan_form.dart';
...
class _JadwalScreenState extends State<JadwalScreen> {
  ...
  final List<Map<String, String>> allStatus = [
    {
  ...
  List<Map<String, String>> getFilteredData() {
    ...
    return allStatus.where((data) => data['status'] == selectedStatus).toList();
  }
